...
export const ListOfFiles=({images,setImageToDisplay, file, setNameOfFiles,nameOfFiles, imageToDisplay}: Props,)=>{
...
<ol>
    ...
    <li> <button name="2" onClick={clickHandler}> {nameOfFiles.file3}  </button></li>
    <li> <button name="3" onClick={clickHandler}> {nameOfFiles.file4}  </button></li>
